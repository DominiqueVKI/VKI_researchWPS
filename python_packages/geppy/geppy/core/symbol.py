...
class PowTerminal(Terminal):
    """
    Jo special terminal type
	SymbolTerminal elevated at the power of an RNCTerminal
    """
...
class PrimitiveSet:
    ...
    def add_pow_terminal(self, name):
        """
        """
        self._terminals.append(PowTerminal(name+'**'))
